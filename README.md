...
- 开源快速接入包：`multi-agent/starter-kit/README.md`
- CLI 草案：`multi-agent/starter-kit/CLI_SPEC_v0.1.md`
- 隐私与兼容护栏：`multi-agent/starter-kit/PRIVACY_AND_COMPATIBILITY.md`
- PR 自动校验工作流：`.github/workflows/multi-agent-config-validate.yml`
- 英文文档：`README.en.md`
